...
subtitle: "Figures and code supporting the paper _Maintenance of community function through compensation breaks down over time in a desert rodent community_, by Renata Diaz and S. K. Morgan Ernest, in _Ecology_: https://doi.org/10.1002/ecy.3709"
author: Renata Diaz
output: 
   # github_document:
   #      df_print: kable
...
knitr::opts_chunk$set(echo = TRUE, fig.dim = c(6, 3))
library(soar)
library(ggplot2)
library(dplyr)
